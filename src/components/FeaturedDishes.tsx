...
const dishCategories: Record<string, Dish[]> = {
  STARTERS: [
    ...
    { name: 'LOADED FRIES', description: 'Hand-cut fries with cheese, peppers, and YO sauce.', price: 'ETB 260', image: 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=400&q=80' },
  ...
  BURGERS: [
    { name: 'YO CLASSIC BURGER', description: 'Grilled beef patty, cheese, lettuce, tomato, onion, and signature sauce.', price: 'ETB 390', image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80', isNew: true },
    ...
    { name: 'SPICY ADAMA BURGER', description: 'Beef patty, local green chili, cheese, tomato, and spicy YO sauce.', price: 'ETB 430', image: 'https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=400&q=80' },
  ...
  SPECIAL: [
    { name: 'YO FAMILY BOX', description: 'Four classic burgers, loaded fries, wings, and four soft drinks.', price: 'ETB 1,650', image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400&q=80', isNew: true },
    ...
    { name: 'YO COMBO', description: 'Classic burger, fries, crispy wings, and a soft drink.', price: 'ETB 620', image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400&q=80' },
  ...
  DESSERTS: [
    ...
    { name: 'YO CHEESECAKE', description: 'Creamy cheesecake with seasonal fruit sauce.', price: 'ETB 230', image: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=400&q=80' },
