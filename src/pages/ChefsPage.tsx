...
const chefs: Chef[] = [
  {
    ...
    experience: '25+ years',
    bio: 'A master chef with 25 years of experience in French and Italian cuisine.',
    fullBio: 'Chef William Joe leads the kitchen at Fegegta Burger in Adama. With years of experience in busy restaurant kitchens, he brings care and consistency to every order. His philosophy is simple: use fresh ingredients, cook with confidence, and make every guest smile.',
    image: 'https://images.unsplash.com/photo-1577219491135-ce391730fb2c?w=600&q=80',
    specialty: 'Burgers & Grill',
    awards: ['Fegegta Team Leader', 'Burger Craft Award', 'Culinary Excellence Recognition'],
    social: [
      { platform: 'Instagram', handle: '@chefwilliamjoe' },
      { platform: 'Twitter', handle: '@chefwilliam' },
    ],
  },
  {
    id: 2,
    ...
    fullBio: 'Chef Sarah Mitchell is a graduate of Le Cordon Bleu and has worked in some of the world finest pastry kitchens. Her innovative approach to dessert-making combines classic French techniques with modern flavors. She has won numerous awards for her signature chocolate creations and is a regular contributor to culinary magazines.',
    image: 'https://images.unsplash.com/photo-1595273670150-bd0c3c392e46?w=600&q=80',
    specialty: 'Desserts & Baking',
    awards: ['Pastry Chef of the Year 2021', 'Best Dessert Award 2019', 'French Pastry Championship 2017'],
    social: [
      { platform: 'Instagram', handle: '@sarahpastry' },
      { platform: 'Twitter', handle: '@sarahmitchell' },
    ],
  },
  {
    id: 3,
    ...
    title: 'Sous Chef',
    experience: '12+ years',
    bio: 'Italian culinary expert specializing in seafood and pasta dishes.',
    fullBio: 'Chef Marco Rossi brings bold grill flavors to Fegegta. His passion for fresh ingredients, careful preparation, and fast service has made him an invaluable member of our kitchen team in Adama.',
    image: 'https://images.unsplash.com/photo-1583394293214-28ded15ee548?w=600&q=80',
    specialty: 'Seafood & Pasta',
    awards: ['Italian Chef Championship 2018', 'Best Seafood Dish Rome 2016'],
    social: [
      { platform: 'Instagram', handle: '@chefmarco' },
      { platform: 'Twitter', handle: '@marcorossi' },
    ],
  },
  {
    id: 4,
    ...
    title: 'Sommelière',
    experience: '10+ years',
    bio: 'Expert wine curator with deep knowledge of French and Italian wines.',
    fullBio: 'Emma Watson is our resident wine expert, curating an extensive wine list that perfectly complements our menu. With certifications from the Court of Master Sommeliers and Wine & Spirit Education Trust, she ensures every guest finds the perfect pairing for their meal.',
    ...
    social: [
      { platform: 'Instagram', handle: '@emmawines' },
      { platform: 'Twitter', handle: '@emmawatson' },
    ],
  },
  {
    id: 5,
    ...
    title: 'Grill Master',
    experience: '18+ years',
    bio: 'Specialist in wood-fire grilling and BBQ techniques.',
    fullBio: 'Chef David Chen is our grill master, specializing in flame-grilled cooking techniques that bring out the best in every burger and cut of meat. His expertise in temperature control, seasoning, and timing ensures every order leaves the kitchen perfectly cooked.',
    image: 'https://images.unsplash.com/photo-1556911073-a525e7100f18?w=600&q=80',
    specialty: 'Wood-fire Grilling',
    awards: ['BBQ Championship Winner 2019', 'Grill Master Award 2021'],
    social: [
      { platform: 'Instagram', handle: '@grillmasterdavid' },
      { platform: 'Twitter', handle: '@davidchen' },
    ],
  },
  {
    id: 6,
    ...
    fullBio: 'Chef Lisa Park brings artistry and innovation to our pastry kitchen. She combines classic techniques with local flavors to create desserts that are as beautiful as they are delicious.',
    image: 'https://images.unsplash.com/photo-1583621135839-f5925c7d96b3?w=600&q=80',
    specialty: 'Artisan Pastries',
    awards: ['Young Pastry Chef Award 2020', 'Creative Dessert Competition 2019'],
    social: [
      { platform: 'Instagram', handle: '@lisapastry' },
      { platform: 'Twitter', handle: '@lisapark' },
    ],
  },
];
