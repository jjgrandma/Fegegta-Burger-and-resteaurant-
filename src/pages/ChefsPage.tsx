...
const chefs: Chef[] = [
  {
    ...
    fullBio: 'Chef Yohannes Alemu leads the kitchen at Fegegta Burger in Adama. With years of experience in busy restaurant kitchens, he brings care and consistency to every order. His philosophy is simple: use fresh ingredients, cook with confidence, and make every guest smile.',
  ...
  },
  {
    ...
    fullBio: 'Chef Selam Tesfaye brings a refined touch to every dessert at Fegegta. Her innovative approach combines traditional Ethiopian flavors with modern pastry techniques. She has earned recognition for her signature creations and continues to delight guests with every plate.',
  ...
  },
  {
    ...
    fullBio: 'Tigist Haile is our resident beverage expert, curating a drink menu that perfectly complements our food. With years of experience in hospitality, she ensures every guest finds the perfect pairing for their meal at Fegegta.',
